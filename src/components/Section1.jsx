        ...
        <Row className="py-5">
          ...
          <Col xl={6} className="pt-5 ps-xl-5">
            ...
            <div className="d-flex pt-2">
              ...
              <p className="mb-0 fw-normal lh-134 light-black fs-md ff-poppins">
                ( 5 Customer Review )
              </p>
            </div>
            <p className="fs-md ff-poppins lh-185 color-black op-6 fw-normal pt-4 pb-5 max-width-610">
            ...
            <div className="d-flex align-items-center gap-3">
              <p className="color-black ff-poppins lh-125 fw-medium fs-md mb-0">
                Qty:
              </p>
              ...
              <a
                href=""
                class="text-white cart-btn ff-poppins lh-125 fw-medium fs-md text-nowrap"
              >
                Add to Cart
              </a>
            </div>
            <div class="d-flex align-items-center gap-3 pt-4">
              <p class="color-black ff-poppins lh-125 fw-medium fs-md mb-0">
                Size:
              </p>
              <div class="border d-flex align-items-center gap-3">
                <div class="color-grey ff-josefin fs-20 lh-125 fw-normal bg-transparent border-none size-border">
                  <label for="cars" className="pe-2" hidden>
                    S
                  </label>
                  <select
                    name="cars"
                    id="cars"
                    class="border-none outline-none pe-4"
                  >
            ...
            <div class="d-flex gap-5 pt-4 align-items-center">
              <div class="d-flex">
                ...
                <div className="d-flex align-items-center">
                  <p class="fs-s lh-125 fw-light mb-0 light-black ff-poppins">
                    Compare
                  </p>
                </div>
              </div>
              <div class="d-flex">
                ...
                <div className="d-flex align-items-center">
                  <p class="fs-s lh-125 fw-light light-black ff-poppins mb-0">
                    Wishlist
                  </p>
                </div>
              </div>
