    ...
    return (
        <div>
            <div className='dark-black'>
                <Container>
                    <Row className='py-4'>
                        <Col lg={5} className=' pt-4 pt-xl-0'>
                            <img src={Footerlogo} alt="footerlogo" />
                            <p className='color-white ff-poppins lh-185 fs-s  fw-normal max-w-448 op-6 mb-0 pb-4'>Sed nec
                                ultricies
                                felis, vitae facilisis
                                ipsum. Morbi id turpis euismod, rhoncus tortor quis,
                                lobortis sapien. Sed
                                imperdiet nulla in leo ullamcorper, in finibus elit porta.</p>
                        ...
                        <Col lg={7} className='pt-lg-5 pt-2'>
                            <Row className='pt-5'>
                                <Col xl={3} lg={4} md={6} sm={6} className='col-6  pt-4 pt-xl-0'>
                                    <p className='ff-poppins fw-semibold color-white fs-sm lh-150 text-nowrap mb-0'>CUSTOM
                                        LINKS</p>
                                    <ul className='ps-0'>
                                        <li className="pt-3"><a href=""
                                            class="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap op-7 line-links">Lorem
                                            ipsum</a></li>
                                        <li className="pt-2"><a href=""
                                            className="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap op-7 line-links">Lorem
                                            ipsum</a></li>
                                    </ul>
                                </Col>
                                <Col xl={3} lg={4} md={6} sm={6} className='col-6  pt-4 pt-xl-0'>
                                    <p className='ff-poppins fw-semibold color-white fs-sm lh-150 text-nowrap m-0'>PRODUCTS</p>
                                    <ul className='ps-0'>
                                        <li className="pt-3"><a href=""
                                            className="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap op-7 line-links">Lorem
                                            ipsum</a></li>
                                ...
                                <Col xl={3} lg={4} md={6} sm={6} className='col-6 pt-4 pt-xl-0'>
                                    <p className='ff-poppins fw-semibold color-white fs-sm lh-150 text-nowrap mb-0'>OUR COMPANY</p>
                                    <ul className='ps-0'>
                                ...
                                <Col xl={3} lg={4} md={6} sm={6} className='col-6 pt-4 pt-xl-0'>
                                    <p className='ff-poppins fw-semibold color-white fs-sm lh-150 text-nowrap mb-0'>YOUR ACCOUNT</p>
                                    <ul className='ps-0'>
                                        <li className='pt-3'><a href=""
                                            class="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap op-7 line-links">Lorem
                                            ipsum</a></li>
                     ...
                     <button class="back-btn pos-fix1 bg-lightbrown back-to-top-button" id="backtotop"
        onclick="window.scrollTo(0,0)"><span><svg width="34" height="35" viewBox="0 0 34 35" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M19.0835 17.5V34.1667H14.9168V17.5H0.333496L17.0002 0.833374L33.6668 17.5H19.0835Z"
                    fill="white" />
            </svg>
        </span></button>
                </Container >
                <div class="browm py-3 mt-5">
                    <p class="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap  text-center op-7 mb-0">Â© Copyright SNKRPLTS 2021.
                    </p>
                </div>
