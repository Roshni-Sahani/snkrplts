...
const Shoescard = () => {
  const list = commoncard.map((commoncard) => (
    <Col xxl={3} lg={4} md={6} className="mb-5 justify-content-center d-flex">
      <Card className="commoncard position-relative z-1 overflow-hidden br-20">
          ...
          <div className="d-flex align-content-center justify-content-between">
            ...
            <span>
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_776_387)" className="cursor-pointer">
                  <path
        ...
        <span className=" ps-2 pt-3 pb-4 cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100"
            height="21"
